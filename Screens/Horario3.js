...
const Hora3 = "Kevin_Orellana/feeds/hora-3";
const Minuto3 = "Kevin_Orellana/feeds/minuto-3";
var client;
...
export default function Horario1({ navigation }) {
  ...
  const onConnect = () => {
    ...
    const hora3 = date3.getHours().toString();
    client.publish(Hora3, hora3);
    const minuto3 = date3.getMinutes().toString();
    client.publish(Minuto3, minuto3);
  };
